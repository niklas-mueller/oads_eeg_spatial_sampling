...
def load_eeg_channel_and_timepoints(eeg_fif_dir, sub):
    # eeg_dir = f'/home/nmuller/projects/fmg_storage/Data/sub_{sub}/Preprocessed epochs/sub_{sub}-OC&CSD-AutoReject-epo.fif'
    epochs = read_epochs(fname=os.path.join(eeg_fif_dir, f'sub_{sub}-OC&CSD-AutoReject-epo.fif'), preload=False, verbose=False)
