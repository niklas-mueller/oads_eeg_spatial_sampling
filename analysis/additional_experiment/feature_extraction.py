...
if __name__ == '__main__':
    ...
    oads_dir = '../../additional_stimuli'
    save_dir = '../../dnn_features'
    
    extract_features(model_type='alexnet_imagenet', oads_dir=oads_dir, save_dir=save_dir, save_to_file=True, subject=12, fileending='.png')
