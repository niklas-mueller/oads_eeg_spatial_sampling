...
def extract_features(model_type, oads_dir, save_dir, save_to_file:bool=True, subjects:list=list(range(5,36)), batch_size:int=16, num_workers:int=8, device='cuda:0', image_width:int=2155, image_height:int=1440):
